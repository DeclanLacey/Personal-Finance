        ...
        <>
            ...
            <section className='add-edit-modal'>
                <div className="add_transaction-title-container">
                    ...
                    <button aria-label="Button to close the current modal" className="close-modal-btn" onClick={() => setShowTransactionModal(false)}> <img alt="a circle with an x inside of it"  className="close-modal-btn-img" src="./assets/icon-close-modal.svg" /></button>
                </div>

                <form onSubmit={handleSubmit}>
                    {/* Name */}
                    <div className="add_transaction-input-container">
                        <label htmlFor="name" className="add-edit-modal-input-label">Name</label>
                    ...
                    <div className="add_transaction-input-container add_transaction-date-amount">
                        ...
                        <div className="transaction-amount-input-container">
                            <label htmlFor="amount" className="add-edit-modal-input-label">Amount</label>
                        ...
                        <div className="add_transaction-input-container add_transaction-date-container">
                            <label htmlFor="date" className="add-edit-modal-input-label">Date</label>
                    ...
                    <div className="add_transaction-selection-container">
                        ...
                        <div className="add_transaction-recurring-container">
                            <label htmlFor="recurring" className="add-edit-modal-input-label">Recurring Transaction?</label>
                        ...
                        <div className="add_transaction-outer-radio-container">
                            <div className="add_transaction-radio-container">
                                <label htmlFor="transactionType" className="add-edit-modal-input-label">Expense</label>
                                <input required name="transactionType" value={"expense"} defaultChecked type="radio" onChange={handleTypeChange}/>
                            </div>
                            <div className="add_transaction-radio-container">
                                <label htmlFor="transactionType" className="add-edit-modal-input-label">Income</label>
                                <input required name="transactionType" value={"income"} type="radio" onChange={handleTypeChange}/>
                            </div>
                        </div>
                    </div>

                    <input aria-label="button to submit the form" type="submit" className="black-add-btn add_transaction-add-btn" value={"Add Transaction"} />
                </form>
            </section>
        </>
    )
